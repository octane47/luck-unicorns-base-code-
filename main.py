...
def instructions():
    ...
    print()
    print(
        "it costs a $1 per round. depending on your prize you might win some money back. here the payout amounts..."
    )
    print()
    ...
    print()
    print(
        "can you avoid the donkeys, get the unicorns and walk with cash in hand?"
    )
    return ""
